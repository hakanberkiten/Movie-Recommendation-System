...
def load_movie_data():
    ...
    # Tek sütunda metinsel özellikleri birleştir
...
def recommend():
    """
    Örnek istek:  GET /recommend?movie=Inception
    """
...
def get_movies():
        """
        Tüm filmleri dönen bir endpoint.
        """
        all_movies = movies_df['title'].tolist()  # Filmlerin başlıklarını liste olarak al
